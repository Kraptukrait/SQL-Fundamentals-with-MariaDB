-- If the database already exists, the script can be executed again
DROP DATABASE IF EXISTS high_school_grading; 

-- Create the database
CREATE DATABASE high_school_grading;

-- Use the created database
USE high_school_grading;
...
-- Create the tbl_subject table
CREATE TABLE tbl_subject (
    pk_subject VARCHAR(35) NOT NULL,
    PRIMARY KEY(pk_subject)
) ENGINE=InnoDB;

-- Create the tbl_assessment_type table
